...
![](images/2025-04-12-21-07-17.png)
...
QUIC 同样采取了多路复用的设计，可以在同一条连接上并发传输多个流，且流之间互相独立，丢包仅会影响当前流，能够彻底解决队头阻塞问题。
...
后续客户端缓存了服务端配置后，可以直接计算通信密钥，则可以在发送 Client Hello 时，同步携带加密后的应用数据，实现 0-RTT 建连。
